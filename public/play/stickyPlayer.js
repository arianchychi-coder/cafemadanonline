...
let stickyTimeCurrent;
let stickyTimeTotal;

let stickyProgressFill;
let stickyProgressInput;
...
let volumeIconMute;
    ...
    stickyPlayer =
    document.getElementById('stickyPlayer');

    stickySpacer =
    document.getElementById('stickySpacer');

    stickyCover =
    document.getElementById('stickyCover');

    stickyTitle =
    document.getElementById('stickyTitle');

    stickyEpisode =
    document.getElementById('stickyEpisode');

    stickyPlayBtn =
    document.getElementById('stickyPlayBtn');

    stickyCloseBtn =
    document.getElementById('stickyCloseBtn');


    stickyPlayIcon =
    stickyPlayBtn?.querySelector(
        '.cm-sticky-player__play-icon'
    );

    stickyPauseIcon =
    stickyPlayBtn?.querySelector(
        '.cm-sticky-player__pause-icon'
    );


    stickyTimeCurrent =
    document.querySelector(
        '.cm-sticky-player__time-current'
    );


    stickyTimeTotal =
    document.querySelector(
        '.cm-sticky-player__time-total'
    );
    ...
    document.querySelectorAll(
        '.cm-sticky-player__speed-option'
    );
